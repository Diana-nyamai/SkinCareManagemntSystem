...
<header>
    ...
    <div class="main-body">
        ...
        <h1>SENSITIVE SKIN PRODUCTS</h1>
    </div>
        <!-- PRODUCTS SECTION -->
        <div class="gallery">
      <?php 
      $res = mysqli_query($conn, "select * from tbl_product where skin_type='sensitive'");
      while($row = mysqli_fetch_array($res)){
          ?>
     
          <div class="g-content"> 
              <form action="./sensitive_cart_manager.php?action=add&id=<?php echo $row["id"];?>" method="post">
